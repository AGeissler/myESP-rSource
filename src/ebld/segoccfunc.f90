...
! using the Fourier function to represent the wave chape of heart beat so more accurate blood flow can be calculated in every time step.
! for that we used the Intel Math Kernel Library MKL 
      ...
      ENDIF
! changing coeficient value to constant (without using mkl library)
