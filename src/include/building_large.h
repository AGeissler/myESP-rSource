...
C Geometry.
      ...
      PARAMETER (MS=250)        ! Surfaces/zone (set MNSBZ in cfd.h to at least 2*MS).
      PARAMETER (MCON=5200)     ! Surfaces in model.
      PARAMETER (MTV=550)       ! Vertices/zone.
...
C Shading/insolation.
      PARAMETER (MB=400)        ! Site obstruction & visual blocks.
      ...
      PARAMETER (MVOBJ=80)     ! Visual objects
...
C      PARAMETER (MNRS=2**MNFA) ! Result sets (set to 100 for sensitivity analysis).
      ...
      PARAMETER (MZS=250)       ! Number of items to report in res (biggest of MCOM or MS).
